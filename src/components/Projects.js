        ...
        <section className="projects">
            ...
            <div className="projects__cards">
                ...
                <div className="projects__card">
                    ...
                    <a href="https://gokou-tstodo.on.fleek.co" target="_blank" className="button">Site</a>
                    <a href="https://github.com/WSGokou/Indecision-app" target="_blank" className="button">Code</a>
                </div>
                <div className="projects__card">
                    <h3>Todo App</h3>
                    <img src={todo} alt="Todo App" />
                    <p>Todo list application built using Typescript, making use of type system and DOM interaction to add todo's to list
                        Hosted on the IPFS using fleek
                    </p>

                    <a href="https://rngeez.netlify.app" target="_blank" className="button">Site</a>
                    <a href="https://github.com/WSGokou/typescript-todo" target="_blank" className="button">Code</a>
                </div>
            </div>
        </section>
    );
